...
CREATE TYPE "public"."account_provider" AS ENUM('google', 'apple', 'github');--> statement-breakpoint
...
CREATE TABLE "users"."accounts" (
	...
	"provider_refresh_token_iv" text,
	"provider_refresh_token_tag" text,
	"provider_refresh_token_expires_at" timestamp with time zone,
...
--> statement-breakpoint
ALTER TABLE "users"."accounts" ADD CONSTRAINT "accounts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users"."sessions" ADD CONSTRAINT "sessions_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "users"."accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "accounts_user_id_idx" ON "users"."accounts" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "sessions_expires_at_idx" ON "users"."sessions" USING btree ("expires_at");