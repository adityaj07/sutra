...
const appleCallbackBodySchema = z.object({
  ...
  id_token: z.string().optional().openapi({
    description:
      "OpenID Connect id_token — may be included in Apple form_post callback",
    example: "eyJraWQiOiJ...",
  }),
});
...
export const postOauthAppleCallbackRoute = createRoute({
  ...
  responses: {
    200: {
      description:
        "Successfully authenticated and tokens generated (when redirect=false in state)",
      content: {
        "application/json": {
          schema: z.object({
...
export const postOauthAppleCallbackHandler: AppRouteHandler<
