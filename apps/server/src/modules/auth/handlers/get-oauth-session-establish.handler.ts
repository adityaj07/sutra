...
import { errorResponseSchemas, verifyJwt } from "@sutra/shared";
...
export type GetOauthSessionEstablishRoute =
  typeof getOauthSessionEstablishRoute;

export const getOauthSessionEstablishHandler: AppRouteHandler<
